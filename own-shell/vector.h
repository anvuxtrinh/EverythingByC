...
i32 __push_back(vector *vec, void *val){
    ...
    void *dict = (char *) vec->data + size/sizeof(char);
...
vector __vector_create(u64 esize, u64 _enum, void *val){
    u64 size = _enum == 0 ? esize : _enum * esize;
    vector vec;
...
void *__vector_at(vector *vec, u64 idx){
    ...
    void *ptr = (char *)vec->data + idx*vec->esize/sizeof(char);
